...
$credits = ('
	...
	<ul>
		...
		<li>JeDaYoshi — Ported all the Acmlmboard XD plugins to BBXD, ported the RPG, coder</li>
		<li>Phase — Added compatibility to 5.7 MySQL databases, JSON ranksets, etc...</li>
		<li>SuperToad - (TBH: I don\'t know exactly what he did and what he didn\'t so I\'ll just leave it like this).</li>
