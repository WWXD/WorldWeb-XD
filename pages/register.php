...
if($_POST['register']) {
	if (IsProxy() || IsProxyFSpamList()) {
		...
		if ($_POST['math'] !== "11")
			$err = __("You seriously need to go to school more.");
...
if (Settings::get('email'))
	echo "Specifying an email address is a requirement. By default, your email is made private.";
else
	echo "Specifying an email address isn't a requirement, but is recommended. By default, your email is made private.";
